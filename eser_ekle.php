...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <form method="post" action="eser_ekle2.php">
      <div class="mb-3">
        <label for="formControl1" class="form-label">Eser ID</label>
      ...
      <div class="mb-3">
        <label for="formControl1" class="form-label">Yayınevi</label>
        <input type="text" class="form-control" id="formControlID" name="yayineviID">
      </div>
