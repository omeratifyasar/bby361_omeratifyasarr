<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM Eser,Yazar WHERE Eser.yazarID = Yazar.yazarID AND yazarAdi LIKE('%$q%') OR yazarSoyadi LIKE('%$q%') OR ISBN LIKE('%$q%') OR eserAdi LIKE('%$q%') OR Dil LIKE('%$q%')");
    ...
    <h2>Eser Kayıtları</h2>
      ...
      <p>
          ...
          while($satir = mysqli_fetch_assoc($sorgu)){
              ...
              printf("<b>Eser YayinYarihi:</b> ".$satir["eserYayınTarih"]."</br>");
              printf("<b>Tür:</b> ".$satir["eserTür"]."</br>");
              printf("<b>Dil:</b> ".$satir["eserDil"]."</br>");
